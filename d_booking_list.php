...
<table border="2" class="display table table-bordered" id="example" align="center" >
  <thead>
    ...
    <th width="5%"><center>ตรวจสอบ</center></th>
  </tr>
</thead>
   ...
   <td align="center">
      ...
      class='btn btn-danger btn-xs'>ไม่อนุมัติ</a> 
       <?php }elseif($bi_status ==2){ ?>
        <a href='profile.php?bi_id=<?php echo $row_book['bi_id']; ?>&do=sss'
      class='btn btn-info btn-xs'> ดูการนัดหมาย </a>  
       <?php }elseif($bi_status ==3){ ?>
        <a href='profile.php?bi_id=<?php echo $row_book['bi_id']; ?>&do=dds'
