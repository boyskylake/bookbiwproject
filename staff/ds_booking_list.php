...
$query_book = "SELECT  tbl_booking.bi_id,tbl_booking.bi_room,tbl_booking.bi_class,tbl_booking.bi_no,tbl_booking.bi_in,tbl_booking.bi_return,tbl_booking.bi_out,tbl_booking.bi_status,tbl_booking.bi_fine,
...
<table border="2" class="display table table-bordered" id="example" align="center" >
  ...
  <?php if($totalRows_book > 0){ do{?>
    ...
    <tr>
      ...
      <a href="ds_booking.php?bi_id=<?php echo $row_book['bi_id']; ?>&act=de">
...
// echo '</font>';
   ...
   <td align="center">
      <?php  
       if($bi_status ==1){ ?>
       <a href='booking.php?bi_id=<?php echo $row_book['bi_id']; ?>&act=ss'
      class='btn btn-info btn-xs'> อนุมัติ </a> 
       <a href='booking.php?bi_id=<?php echo $row_book['bi_id']; ?>&act=ds'
      class='btn btn-danger btn-xs'>ไม่อนุมัติ</a> 
       <?php }elseif($bi_status ==2){ ?>
        <a href='booking.php?bi_id=<?php echo $row_book['bi_id']; ?>&act=sss'
      class='btn btn-info btn-xs'> ดูการนัดหมาย </a>  
       <?php }elseif($bi_status ==3){ ?>
        <a href='ds_booking.php?bi_id=<?php echo $row_book['bi_id']; ?>&act=ds'
      class='btn btn-danger btn-xs'>เหตุผล</a> 
      <?php } ?>
  </td>
    </tr>
