...
<table border="2" class="display table table-bordered" id="example" align="center" >
 ...
 <?php if($totalRows_book > 0){ do{?>
    ...
    <tr>
      ...
      <a href="index.php?bi_id=<?php echo $row_book['bi_id']; ?>&act=de">
...
// echo '</font>';
   ...
   <td align="center">
      <?php  
       if($bi_status ==1){ ?>
       <a href='index.php?bi_id=<?php echo $row_book['bi_id']; ?>&act=ss&id=<?php echo $row_book['mem_id']; ?>'
      class='btn btn-info btn-xs'> อนุมัติ </a> 
       <a href='index.php?bi_id=<?php echo $row_book['bi_id']; ?>&act=ds'
      ...
      class='btn btn-info btn-xs'> ดูการนัดหมาย </a>  
       <?php }elseif($bi_status ==3){ ?>
        <a href='booking.php?bi_id=<?php echo $row_book['bi_id']; ?>&act=dds'
